...
urlpatterns = [
    ...
    path('form/comentar', forms.form_comentar, name='form_comentar'),
    ...
    path('stats/whatsapp', views.whatsapp, name = 'whatsapp'),
    path('stats_whatsapp', views.stats_whatsapp, name = 'stats_whatsapp'),
